## @webundsoehne/patch-package [4.0.2-beta.1](https://gitlab.tailored-apps.com/bdsm/nx-skeleton/compare/@webundsoehne/patch-package@4.0.1...@webundsoehne/patch-package@4.0.2-beta.1) (2022-10-21)
...
# @webundsoehne/patch-package [3.3.0-beta.1](https://gitlab.tailored-apps.com/bdsm/nx-skeleton/compare/@webundsoehne/patch-package@3.2.0...@webundsoehne/patch-package@3.3.0-beta.1) (2022-04-19)
...
# @webundsoehne/patch-package [3.2.0](https://github.com/tailoredmedia/backend-nx-skeleton/compare/@webundsoehne/patch-package@3.1.0...@webundsoehne/patch-package@3.2.0) (2022-02-17)
...
# @webundsoehne/patch-package [3.2.0-beta.1](https://github.com/tailoredmedia/backend-nx-skeleton/compare/@webundsoehne/patch-package@3.1.0...@webundsoehne/patch-package@3.2.0-beta.1) (2022-02-15)

### Features

- use npx or yarn exec like paths instead of hardcoding for windows ([d1172a7](https://github.com/tailoredmedia/backend-nx-skeleton/commit/d1172a7ebe345347ba72b8ffa24f544cfeef56c1))

# @webundsoehne/patch-package [3.1.0](https://github.com/tailoredmedia/backend-nx-skeleton/compare/@webundsoehne/patch-package@3.0.2...@webundsoehne/patch-package@3.1.0) (2022-02-05)
...
## @webundsoehne/patch-package [3.0.2](https://github.com/tailoredmedia/backend-nx-skeleton/compare/@webundsoehne/patch-package@3.0.1...@webundsoehne/patch-package@3.0.2) (2022-02-04)
...
## @webundsoehne/patch-package [3.0.1](https://github.com/tailoredmedia/backend-nx-skeleton/compare/@webundsoehne/patch-package@3.0.0...@webundsoehne/patch-package@3.0.1) (2022-02-04)
...
# @webundsoehne/patch-package [3.0.0](https://github.com/tailoredmedia/backend-nx-skeleton/compare/@webundsoehne/patch-package@2.1.2...@webundsoehne/patch-package@3.0.0) (2022-02-04)
...
# @webundsoehne/patch-package [3.0.0-beta.1](https://github.com/tailoredmedia/backend-nx-skeleton/compare/@webundsoehne/patch-package@2.1.2...@webundsoehne/patch-package@3.0.0-beta.1) (2022-01-26)
...
## @webundsoehne/patch-package [2.1.2](https://github.com/tailoredmedia/backend-nx-skeleton/compare/@webundsoehne/patch-package@2.1.1...@webundsoehne/patch-package@2.1.2) (2021-12-21)

### Bug Fixes

- update deps ([5fec378](https://github.com/tailoredmedia/backend-nx-skeleton/commit/5fec378da5e4beea574bd9df24e71d0915f9212a))

## @webundsoehne/patch-package [2.1.1](https://github.com/tailoredmedia/backend-nx-skeleton/compare/@webundsoehne/patch-package@2.1.0...@webundsoehne/patch-package@2.1.1) (2021-12-20)
...
# @webundsoehne/patch-package [2.1.0](https://github.com/tailoredmedia/backend-nx-skeleton/compare/@webundsoehne/patch-package@2.0.2...@webundsoehne/patch-package@2.1.0) (2021-12-20)
...
## @webundsoehne/patch-package [2.0.2](https://github.com/tailoredmedia/backend-nx-skeleton/compare/@webundsoehne/patch-package@2.0.1...@webundsoehne/patch-package@2.0.2) (2021-09-16)

### Bug Fixes

- use provided package instead of the custom one ([830f4da](https://github.com/tailoredmedia/backend-nx-skeleton/commit/830f4dab100fc6ff60baeac0da40e76140255abd))

## @webundsoehne/patch-package [2.0.1](https://github.com/tailoredmedia/backend-nx-skeleton/compare/@webundsoehne/patch-package@2.0.0...@webundsoehne/patch-package@2.0.1) (2021-09-15)
...
# @webundsoehne/patch-package [2.0.0](https://github.com/tailoredmedia/backend-nx-skeleton/compare/@webundsoehne/patch-package@1.0.4...@webundsoehne/patch-package@2.0.0) (2021-08-20)
...
## @webundsoehne/patch-package [1.0.4](https://github.com/tailoredmedia/backend-nx-skeleton/compare/@webundsoehne/patch-package@1.0.3...@webundsoehne/patch-package@1.0.4) (2021-06-01)
...
## @webundsoehne/patch-package [1.0.3](https://github.com/tailoredmedia/backend-nx-skeleton/compare/@webundsoehne/patch-package@1.0.2...@webundsoehne/patch-package@1.0.3) (2021-05-27)
...
## @webundsoehne/patch-package [1.0.2](https://github.com/tailoredmedia/backend-nx-skeleton/compare/@webundsoehne/patch-package@1.0.1...@webundsoehne/patch-package@1.0.2) (2021-03-05)

### Bug Fixes

- add missing deps ([aaa2d2c](https://github.com/tailoredmedia/backend-nx-skeleton/commit/aaa2d2c4d7116c80581a2dcd2db712c2f3ca4336))

## @webundsoehne/patch-package [1.0.1](https://github.com/tailoredmedia/backend-nx-skeleton/compare/@webundsoehne/patch-package@1.0.0...@webundsoehne/patch-package@1.0.1) (2021-03-04)

### Bug Fixes

- add class transformer fix ([60b6785](https://github.com/tailoredmedia/backend-nx-skeleton/commit/60b6785807150349c384850f08085c846bacabf9))
...
- fix again how command is handled ([117ef1a](https://github.com/tailoredmedia/backend-nx-skeleton/commit/117ef1aba9a466b99187d44200363ff05ce11ac4))
- improve grouping of patches ([f7c07d1](https://github.com/tailoredmedia/backend-nx-skeleton/commit/f7c07d11b2e9104737b482bf3a729501a1ad938e))

### Features

- update patch-package to use globs ([762b989](https://github.com/tailoredmedia/backend-nx-skeleton/commit/762b989d372dd0fe0faacf3d6dcde8366338df19))
