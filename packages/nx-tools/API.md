...
<dt><a href="#addEslintToWorkspace">addEslintToWorkspace(host, log, options, {{json:any}, })</a> ⇒</dt>
...
<a name="addEslintToWorkspace"></a>

## addEslintToWorkspace(host, log, options, {{json:any}, }) ⇒
