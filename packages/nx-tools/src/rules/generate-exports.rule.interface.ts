...
export interface GenerateExportsJinjaTemplateOptions {
  ...
  root: string
  templates: {
    /** The cwd from where exports will be relatively generated. This is mostly required because the nx way is to move this file after the processing is finished. */
    cwd?: string
