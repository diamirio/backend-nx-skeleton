## @webundsoehne/eslint-config [6.0.2](https://gitlab.tailored-apps.com/bdsm/nx-skeleton/compare/@webundsoehne/eslint-config@6.0.1...@webundsoehne/eslint-config@6.0.2) (2022-12-13)

### Bug Fixes

- update irrelevant fields ([691888a](https://gitlab.tailored-apps.com/bdsm/nx-skeleton/commit/691888a429560d4ae15b18002e074ef7df867585))
...
## @webundsoehne/eslint-config [5.2.2](https://gitlab.tailored-apps.com/bdsm/nx-skeleton/compare/@webundsoehne/eslint-config@5.2.1...@webundsoehne/eslint-config@5.2.2) (2022-04-19)
...
## @webundsoehne/eslint-config [5.2.1](https://gitlab.tailored-apps.com/bdsm/nx-skeleton/compare/@webundsoehne/eslint-config@5.2.0...@webundsoehne/eslint-config@5.2.1) (2022-04-19)

### Bug Fixes

- update repo url ([bbc48e3](https://gitlab.tailored-apps.com/bdsm/nx-skeleton/commit/bbc48e30f42691ef3513eb47b0776b9658409bc1))

# @webundsoehne/eslint-config [5.2.0](https://gitlab.tailored-apps.com/bdsm/nx-skeleton/compare/@webundsoehne/eslint-config@5.1.5...@webundsoehne/eslint-config@5.2.0) (2022-04-19)
...
# @webundsoehne/eslint-config [5.2.0-beta.1](https://gitlab.tailored-apps.com/bdsm/nx-skeleton/compare/@webundsoehne/eslint-config@5.1.5...@webundsoehne/eslint-config@5.2.0-beta.1) (2022-04-19)
...
## @webundsoehne/eslint-config [5.1.5](https://gitlab.tailored-apps.com/bdsm/nx-skeleton/compare/@webundsoehne/eslint-config@5.1.4...@webundsoehne/eslint-config@5.1.5) (2022-04-07)
...
## @webundsoehne/eslint-config [5.1.2](https://gitlab.tailored-apps.com/bdsm/nx-skeleton/compare/@webundsoehne/eslint-config@5.1.1...@webundsoehne/eslint-config@5.1.2) (2022-04-05)
...
## @webundsoehne/eslint-config [5.1.1](https://github.com/tailoredmedia/backend-nx-skeleton/compare/@webundsoehne/eslint-config@5.1.0...@webundsoehne/eslint-config@5.1.1) (2022-02-21)

### Bug Fixes

- update for stephans style ([43c719f](https://github.com/tailoredmedia/backend-nx-skeleton/commit/43c719f61bef41a5c84d18be2a259b37975f1306))

# @webundsoehne/eslint-config [5.1.0](https://github.com/tailoredmedia/backend-nx-skeleton/compare/@webundsoehne/eslint-config@5.0.0...@webundsoehne/eslint-config@5.1.0) (2022-02-17)
...
# @webundsoehne/eslint-config [5.1.0-beta.2](https://github.com/tailoredmedia/backend-nx-skeleton/compare/@webundsoehne/eslint-config@5.1.0-beta.1...@webundsoehne/eslint-config@5.1.0-beta.2) (2022-02-17)

### Features

- infer package version from the workspace version ([76fbd98](https://github.com/tailoredmedia/backend-nx-skeleton/commit/76fbd986936e62e6da735194649fd1a38de38061))

# @webundsoehne/eslint-config [5.1.0-beta.1](https://github.com/tailoredmedia/backend-nx-skeleton/compare/@webundsoehne/eslint-config@5.0.0...@webundsoehne/eslint-config@5.1.0-beta.1) (2022-02-15)

### Features

- use npx or yarn exec like paths instead of hardcoding for windows ([d1172a7](https://github.com/tailoredmedia/backend-nx-skeleton/commit/d1172a7ebe345347ba72b8ffa24f544cfeef56c1))

# @webundsoehne/eslint-config [5.0.0](https://github.com/tailoredmedia/backend-nx-skeleton/compare/@webundsoehne/eslint-config@4.0.1...@webundsoehne/eslint-config@5.0.0) (2022-02-04)
...
- update rule ([8254c2a](https://github.com/tailoredmedia/backend-nx-skeleton/commit/8254c2a5ca699ea043030551b46165852d0b0e16))
...
- add import helper ([6137288](https://github.com/tailoredmedia/backend-nx-skeleton/commit/6137288a575e66a98652457273a79743d2952fc4))
...
# @webundsoehne/eslint-config [5.0.0-beta.1](https://github.com/tailoredmedia/backend-nx-skeleton/compare/@webundsoehne/eslint-config@4.0.1...@webundsoehne/eslint-config@5.0.0-beta.1) (2022-01-26)
...
## @webundsoehne/eslint-config [4.0.1](https://github.com/tailoredmedia/backend-nx-skeleton/compare/@webundsoehne/eslint-config@4.0.0...@webundsoehne/eslint-config@4.0.1) (2021-08-23)

### Bug Fixes

- errors for parsing html templates on angular application ([4c2d1da](https://github.com/tailoredmedia/backend-nx-skeleton/commit/4c2d1dad3b7c86792e1412f5b0220236a07ca3a2))

# @webundsoehne/eslint-config [4.0.0](https://github.com/tailoredmedia/backend-nx-skeleton/compare/@webundsoehne/eslint-config@3.0.2...@webundsoehne/eslint-config@4.0.0) (2021-08-20)
...
## @webundsoehne/eslint-config [3.0.2](https://github.com/tailoredmedia/backend-nx-skeleton/compare/@webundsoehne/eslint-config@3.0.1...@webundsoehne/eslint-config@3.0.2) (2021-06-01)
...
## @webundsoehne/eslint-config [3.0.1](https://github.com/tailoredmedia/backend-nx-skeleton/compare/@webundsoehne/eslint-config@3.0.0...@webundsoehne/eslint-config@3.0.1) (2021-05-27)
...
# @webundsoehne/eslint-config [3.0.0](https://github.com/tailoredmedia/backend-nx-skeleton/compare/@webundsoehne/eslint-config@2.1.2...@webundsoehne/eslint-config@3.0.0) (2021-03-04)
...
## @webundsoehne/eslint-config [2.1.2](https://github.com/tailoredmedia/backend-nx-skeleton/compare/@webundsoehne/eslint-config@2.1.1...@webundsoehne/eslint-config@2.1.2) (2021-02-09)

### Bug Fixes

- bump packages of eslint that is failing ([839f06a](https://github.com/tailoredmedia/backend-nx-skeleton/commit/839f06a7d903b3894a0d2e0eb8f6ee798ff00d38))

## @webundsoehne/eslint-config [2.1.1](https://github.com/tailoredmedia/backend-nx-skeleton/compare/@webundsoehne/eslint-config@2.1.0...@webundsoehne/eslint-config@2.1.1) (2020-11-26)
...
# @webundsoehne/eslint-config [2.1.0](https://github.com/tailoredmedia/backend-nx-skeleton/compare/@webundsoehne/eslint-config@2.0.0...@webundsoehne/eslint-config@2.1.0) (2020-11-26)

### Features

- bump all ([f44d875](https://github.com/tailoredmedia/backend-nx-skeleton/commit/f44d8759906a5c0050c7b711e3f1a923b3303ca3))

## @webundsoehne/eslint-config [1.1.1](https://github.com/tailoredmedia/backend-nx-skeleton/compare/@webundsoehne/eslint-config@1.1.0...@webundsoehne/eslint-config@1.1.1) (2020-11-25)
...
## @webundsoehne/eslint-config [1.0.1](https://github.com/tailoredmedia/backend-nx-skeleton/compare/@webundsoehne/eslint-config@1.0.0...@webundsoehne/eslint-config@1.0.1) (2020-11-24)
...
# [@webundsoehne/eslint-config-v1.1.0](https://github.com/tailoredmedia/backend-nx-skeleton/compare/@webundsoehne/eslint-config-v1.0.2...@webundsoehne/eslint-config-v1.1.0) (2020-10-14)
...
# [@webundsoehne/eslint-config-v1.0.2](https://github.com/tailoredmedia/backend-nx-skeleton/compare/@webundsoehne/eslint-config-v1.0.1...@webundsoehne/eslint-config-v1.0.2) (2020-09-23)

### Bug Fixes

- update lint setupo ([8c58401](https://github.com/tailoredmedia/backend-nx-skeleton/commit/8c58401fe579c63d487b3405f1a4b5a6b467133f))

# [@webundsoehne/eslint-config-v1.0.1](https://github.com/tailoredmedia/backend-nx-skeleton/compare/@webundsoehne/eslint-config-v1.0.0...@webundsoehne/eslint-config-v1.0.1) (2020-09-18)
