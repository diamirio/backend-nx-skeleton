...
# source me: source <(curl -s "https://gist.githubusercontent.com/cenk1cenk2/02a6451d92f063c7ad1233dd73ba6059/raw/mysql-initialize.sh?$(date +%s)")
...
for i in ${MYSQL_INITDB_MULTIPLE[@]}; do
  ...
  log_start "Init database: ${i} with user '${MYSQL_USER}'" "bottom"
