 ...
 */
export const PrettyNamesForAvailableThingies: PrettyNames<AvailableComponents | AvailableServerTypes | AvailableDBTypes | AvailableMicroserviceTypes | AvailableExtensions> = {
